...
export default async function AdminMenuPageContentPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-ink/60">
          Edit the public Menu page heading and support copy. Product records
          remain managed in the Menu Items area.
        </p>
      </div>
      ...
      <PageContentForm
        ...
        description="These fields control the page heading, intro card, and support cards above the menu browser."

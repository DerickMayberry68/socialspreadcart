    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-ink/60">
          Edit public Contact page heading, planning copy, contact cards, and
          expectation text. Submitted quotes remain managed separately.
        </p>
      </div>
      ...
      <PageContentForm
        pageKey="contact"
        title="Contact page"
        description="These fields control the copy and contact-detail cards that surround the quote form."

...
export default async function AdminPathwayCardsPage() {
  const cards = await withCurrentTenant(SiteContentService.getPathwayCards);
  ...
  return (
    <div className="space-y-6">
      ...
      <PathwayCardsManager initial={cards} />
    </div>
  );
}

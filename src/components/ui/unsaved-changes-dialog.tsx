...
export function UnsavedChangesDialog({
  ...
  description = "You have not saved your edits. If you leave now, those changes will be lost.",
    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[min(calc(100vw-2rem),28rem)] -translate-x-1/2 -translate-y-1/2 rounded-[24px] border border-sage/20 bg-white p-7 text-center shadow-soft outline-none">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border-4 border-amber-100 bg-amber-50 text-amber-700">
